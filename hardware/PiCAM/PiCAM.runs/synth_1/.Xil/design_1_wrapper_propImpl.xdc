set_property SRC_FILE_INFO {cfile:/home/ernesto/workstation/Systems_Cleanbot/hardware/PiCAM/PiCAM.srcs/constrs_1/new/cosnt.xdc rfile:../../../PiCAM.srcs/constrs_1/new/cosnt.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVDS_25     } [get_ports { dphy_hs_clock_0_clk_n }]; #IO_L14N_T2_AD4N_SRCC_35 Sch=mipi_clk_n
set_property src_info {type:XDC file:1 line:169 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVDS_25     } [get_ports { dphy_hs_clock_0_clk_p }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=mipi_clk_p
...
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS33 	PULLUP true} [get_ports { cam_gpio_tri_io }]; #IO_L18N_T2_AD13N_35 Sch=cam_gpio
set_property src_info {type:XDC file:1 line:175 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { IIC_scl_io }]; #IO_L15N_T2_DQS_AD12N_35 Sch=cam_scl
set_property src_info {type:XDC file:1 line:176 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { IIC_sda_io }]; #IO_L15P_T2_DQS_AD12P_35 Sch=cam_sda
